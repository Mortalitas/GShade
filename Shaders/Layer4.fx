...
BLENDING_COMBO(Layer4_BlendMode, "Blending Mode", "Select the blending mode applied to the layer.", "", false, 0, 0)
...
void PS_Layer4(in float4 pos : SV_Position, float2 texCoord : TEXCOORD, out float4 passColor : SV_Target) {
    ...
    BLENDING_LERP(Layer4_BlendMode, backColor, passColor, passColor.a * Layer4_Blend)
