...
#define _SOURCE_COPYRIGHT_SIZE 800.0, 100.0       // Cannot be known by error if value is wrong. Make sure to type correctly. テクスチャの横解像度、縦解像度。数値が間違っていてもエラーメッセージは出ないので注意してください。
